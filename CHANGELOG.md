...
- A macOS `getattrlistbulk` directory-name fast path with first-page-only `readdir` fallback, plus
  bounded NTFS layout/USN parsers and a read-only Windows native qualification probe.
