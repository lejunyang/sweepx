...
- `sweepx scan` performs a synchronous, read-only Linux scan and reports that cell as **degraded**. The macOS and Windows scanners are unsupported compilation stubs.
