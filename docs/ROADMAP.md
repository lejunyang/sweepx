...
The following documentation-facing milestones landed in code on `2026-08-28` and are now reflected in the current docs set. These are implementation records, not qualification claims.
