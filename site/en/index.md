...
hero:
  ...
  tagline: "A runnable development-grade disk-analysis CLI/TUI with an explicitly confirmed operating-system Trash preview."
  image:
    src: /mark.svg
    alt: SweepX
  actions:
...
features:
  ...
  - title: Trash-first preview
    details: CLI and TUI can move one revalidated item to the operating-system Trash after explicit confirmation. There is no Permanent fallback, and plan/approve/execute remain unavailable.
---
